...
export const siteConfig: SiteConfig = {
	...
	banner: {
		...
		homeText: {
			...
			title: "Look first, then leap.", // 主页横幅主标题
			/* 
			subtitle: [
...
export const profileConfig: ProfileConfig = {
	avatar: "assets/images/Lain00.jpg", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "Eitan",
	bio: "还没想好写什么",
	links: [
		{
	...
	umami: {
		...
		shareId: "dKIyIX0pgbDq0OGJ", //填入共享URL最后面那一串  比如：https://eu.umami.is/api/share/2dKQ5T0WrUn6AYtr 你就填入2dKQ5T0WrUn6AYtr
